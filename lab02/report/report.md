...
subtitle: "Лабораторная №2. Задача о погоне. Вариант 44"
...
![траектории для случая 1](image/image01.png){ #fig:001 width=70% height=70% }
...
![траектории для случая 2](image/image02.png){ #fig:002 width=70% height=70% }
